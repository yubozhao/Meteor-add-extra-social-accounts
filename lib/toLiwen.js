...
//这些文件属于这几个package中.   accounts-base, accounts-oauth-helper, accounts-oauth-helper1,  和 accounts-oauth-helper2
...
var twitter = { 
	...
	"services" : { 
		"resume" : { 
			"loginTokens" : [ 	{ 	"token" : "Ewt73haXCPZjyYBvD", 	"when" : 1367016533855 }, 	{ 	"token" : "vJsmocyXgqwrzJjDK", 	"when" : 1367017211819 } ] }, 
		"twitter" : { 
...
var facebook = { 
	...
	"services" : { 
		...
		"resume" : { 
			"loginTokens" : [ { "token" : "e3EYxwSftKKEwPGiv", "when" : 1367271090498 } ] 
		} 
	}, 
	"profile" : { 
		"name" : "Bozhao Yu" 
...
var selfRegister = { 
	...
	"services" : { 
		...
		"resume" : { 
			"loginTokens" : [ { "token" : "CasGu3tFZfMA5HAme", "when" : 1367271537301 } ] 
		} 
	}, 
